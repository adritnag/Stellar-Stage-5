        ...
        return (
            <View style={styles.contentCard}>
                ...
                <View style={{ padding: 20 }}>
                    <Text style={{ fontWeight: 'bold', fontSize: 22, color: 'darkmagenta' }}>{item.name}</Text>
                    <Text style={{ color: '#7045FF', fontSize: 15 }}>{item.agency.name}</Text>
                    <View style={{ marginTop: 10 }}>
                        <Text style={{ color: '#7D2289', fontSize: 14 }}>{item.agency.description}</Text>
                    </View>
                </View>
            </View>
        )
